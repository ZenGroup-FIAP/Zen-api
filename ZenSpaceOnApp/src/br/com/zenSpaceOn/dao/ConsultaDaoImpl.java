...
public class ConsultaDaoImpl implements ConsultaDao {
	...
	public void deleteByPaciente(Integer codigo) throws SQLException {
		conn = ConnectionOracle.getInstance();
		String sql = "DELETE FROM T_ZSO_CONSULTA WHERE CD_PACIENTE=?";
		PreparedStatement ps = conn.getConnection().prepareStatement(sql);
		ps.setInt(1, codigo);
	...
	public void deleteByPsicologo(Integer codigo) throws SQLException {
		conn = ConnectionOracle.getInstance();
		String sql = "DELETE FROM T_ZSO_CONSULTA WHERE CD_PSICOLOGO=?";
		PreparedStatement ps = conn.getConnection().prepareStatement(sql);
		ps.setInt(1, codigo);
	...
	public void deleteByAgendamento(Integer codigo) throws SQLException {
		conn = ConnectionOracle.getInstance();
		String sql = "DELETE FROM T_ZSO_CONSULTA WHERE CD_AGENDAMENTO=?";
		PreparedStatement ps = conn.getConnection().prepareStatement(sql);
		ps.setInt(1, codigo);
